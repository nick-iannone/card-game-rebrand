...
import { faCity, faCommentAltExclamation, faCommentAltLines, faCommentAltSlash} from '@fortawesome/pro-solid-svg-icons'
...
library.add(faPaperPlane, faMicrochip, falCoins, faFileChartLine , faChartNetwork , faBell, faCoin, faCity, faCoins, faMinusSquare, faCommentAltExclamation, faCommentAltLines, faCommentAltSlash, faSignOutAlt, faShieldAlt, faUserShield, faPlusSquare, faTrashAlt, faScroll, faUsers, faCaretCircleRight, faAlignJustify, faHandPaper, faCircle, faSmile, faStarOfLife, falScrollOld, fadScrollOld, falHelmetBattle, fadDiceD20, fadHelmetBattle, falSword, fadSword)
